...
const BarcodeScanner: React.FC<BarcodeScannerProps> = ({ onScanSuccess, onScanFailure }) => {
 ...
 {error ? (
 <div className="flex flex-col items-center justify-center p-8 bg-white dark:bg-slate-800 text-center gap-2 w-full h-full">
 <AlertCircle className="text-red-500"size={32} />
 <p className="font-bold text-slate-800 dark:text-white">Erro na Câmera</p>
 ...
 <Camera className="animate-pulse mb-3 text-primary"size={40} />
