...
export const SectionModal: React.FC<SectionModalProps> = ({ section, isOpen, onClose, isDarkMode, activeTab, onNavigate }) => {
 ...
 transform transition-all duration-400 origin-bottom
 ...
 <span className={`flex-1 font-medium text-sm text-left ${textMain}`}>{item.label}</span>
