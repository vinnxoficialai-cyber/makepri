...
import { Settings, Moon, Sun, LogOut, ChevronRight, Edit3, Palette } from'lucide-react';
...
export const ProfileDropdown: React.FC<ProfileDropdownProps> = ({
 user, isDarkMode, onToggleTheme, onLogout, onNavigate
}) => {
 ...
 icon: Edit3,
 label:'Editar Perfil',
 action: () => { onNavigate('settings'); setIsOpen(false); },
 description:'Alterar suas informacoes',
 },
 {
 icon: Palette,
