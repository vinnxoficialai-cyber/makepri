...
'Content-Type':'application/json'
 ...
 id: (Date.now() + 1).toString(),
 role:'model',
 text:' Desculpe, tive um problema ao processar sua mensagem. Verifique sua conexão e tente novamente.',
 timestamp: new Date()
 };
 ...
 if (!apiKey) {
 return (
 <div className={`flex flex-col bg-white dark:bg-slate-800 overflow-hidden relative ${isModal ?'h-full':'h-[calc(100vh-6rem)] rounded-xl shadow-sm border border-slate-100 dark:border-slate-700'}`}>
 <div className={`p-4 border-b border-slate-100 dark:border-slate-700 bg-gradient-to-r from-indigo-600 to-purple-600 flex justify-between items-center text-white ${isModal ?'rounded-t-xl':''}`}>
 ...
 <div>
 <h3 className="text-xl font-bold text-slate-800 dark:text-white">Configurar Chave API</h3>
 <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">Para usar a PrimakeAI, insira sua chave API do Groq. Ela será salva localmente no seu navegador.</p>
 </div>
 ...
 placeholder="gsk_..."
 className="w-full p-3 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/20/50 text-sm font-mono"
 />
 <DSButton
 ...
 <p className="text-[10px] text-slate-400">Obtenha sua chave em <a href="https://console.groq.com"target="_blank"rel="noreferrer"className="text-indigo-500 underline">console.groq.com</a></p>
 </div>
 </div>
 </div>
 );
 ...
 ?'bg-primary-50 dark:bg-primary/900/50 text-primary'
 ...
 ?'bg-primary/30 text-slate-900 rounded-tr-none'
 ...
 <div className="bg-white dark:bg-slate-800 p-3 rounded-2xl rounded-tl-none border border-slate-100 dark:border-slate-700 flex items-center gap-2 text-slate-500">
 ...
 <div className="px-4 pb-2 bg-slate-50 dark:bg-slate-900/50">
...
'Análise do ticket médio'
 ...
 className="text-xs px-3 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full text-slate-600 dark:text-slate-300 hover:border-indigo-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors shadow-sm"
 >
 {suggestion}
 </button>
 ))}
 ...
 className="flex-1 p-3 pr-10 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/20/50 focus:border-primary transition-all shadow-sm text-sm"
 disabled={isLoading}
 autoFocus={isModal}
 />
 <DSButton
