...
const SalesGoals: React.FC<SalesGoalsProps> = ({ users, salesGoals, setSalesGoals, currentUser }) => {
 ...
 <Target size={64} className="text-slate-200 dark:text-slate-700 mb-4"/>
 ...
 <div className="flex flex-col md:flex-row justify-between items-center bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700">
 <div className="flex items-center gap-3 mb-4 md:mb-0 w-full md:w-auto">
 <div className="p-3 bg-primary-50 dark:bg-primary/900/30 text-primary dark:text-primary rounded-lg">
 <Target size={24} />
 </div>
 <div>
 <h2 className="text-2xl font-bold text-slate-800 dark:text-white">Metas da Equipe</h2>
 <p className="text-slate-500 dark:text-slate-400 text-sm">Planejamento mensal de vendas.</p>
 </div>
 </div>

 <div className="flex items-center gap-4 bg-slate-50 dark:bg-slate-700/50 p-1.5 rounded-xl border border-slate-200 dark:border-slate-600">
 <button onClick={() => changeMonth(-1)} className="p-2 hover:bg-white dark:hover:bg-slate-600 rounded-lg transition-colors text-slate-600 dark:text-slate-300 shadow-sm">
 <ChevronLeft size={20} />
 </button>
 <div className="flex items-center gap-2 px-4 w-40 justify-center font-bold text-slate-800 dark:text-white select-none">
 ...
 <div className="flex items-center gap-2 text-primary/70 mb-3 font-bold uppercase tracking-wider text-xs">
 ...
 <p className="text-sm text-slate-400 mt-1">Soma das metas individuais</p>
 </div>
 ...
 <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col h-full overflow-hidden">
 ...
 <Users size={20} className="text-primary dark:text-primary"/> Definir Metas Individuais
 </h3>
 <span className="text-xs font-bold px-2.5 py-1 bg-slate-200 dark:bg-slate-600 rounded-full text-slate-600 dark:text-slate-300">
 ...
 return (
 <div key={member.id} className="flex items-center gap-4 p-4 border border-slate-100 dark:border-slate-700 rounded-xl hover:shadow-md transition-all hover:border-primary100 dark:hover:border-slate-600 bg-white dark:bg-slate-800">
 ...
 <span className={`text-[10px] font-bold ${progress >= 100 ?'text-emerald-600':'text-slate-500'}`}>{progress.toFixed(0)}%</span>
 </div>
 </div>

 <div className="relative w-36 group">
 <label className="text-[10px] font-bold text-slate-400 uppercase absolute -top-2 left-0 transition-colors group-focus-within:text-primary">
 ...
 placeholder="0.00"
 className="w-full pl-9 pr-3 py-2.5 border-2 border-slate-100 dark:border-slate-600 rounded-xl focus:outline-none focus:border-primary/50 dark:focus:border-primary bg-slate-50 dark:bg-slate-700/50 text-right font-bold text-slate-900 dark:text-white transition-all focus:bg-white dark:focus:bg-slate-700 focus:shadow-sm"
 />
 </div>
 </div>
 );
 ...
 <div className="p-5 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/30 flex justify-end">
 <DSButton
 onClick={handleSave}
 disabled={loading}
 variant="primary"
