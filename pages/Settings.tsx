    ...
    const handleSaveUser = (e: React.FormEvent) => {
        ...
        if (editingUserId) {
            ...
            setUsers(users.map(u => {
                if (u.id === editingUserId) {
                    const updatedUser = {
                        ...
                        avatarUrl: userForm.avatarUrl || u.avatarUrl
                    } as User;

                    // IMPORTANT: If we are modifying the currently logged in user, update their session state
            ...
            const userToAdd: User = {
                ...
                permissions: userForm.permissions || [],
                active: true,
                avatarUrl: userForm.avatarUrl || `https://picsum.photos/seed/${Math.random()}/40/40`
            };
                ...
                <div className="flex border-b border-gray-100 dark:border-gray-700 overflow-x-auto">
                    <button 
                        ...
                        className={`px-6 py-4 text-sm font-medium transition-colors border-b-2 flex items-center gap-2 whitespace-nowrap ${
                            activeTab === 'users' ? 'border-[#ffc8cb] text-gray-900 dark:text-white' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                        }`}
                    >
                    ...
                    <button 
                         ...
                         className={`px-6 py-4 text-sm font-medium transition-colors border-b-2 flex items-center gap-2 whitespace-nowrap ${
                            activeTab === 'company' ? 'border-[#ffc8cb] text-gray-900 dark:text-white' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                        }`}
                    >
