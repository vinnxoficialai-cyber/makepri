...
const Reports: React.FC = () => {
    ...
    // Zeroed Data Generators
    const getGeneralChartData = () => {
        if (period === 'day') {
            return [
                { name: '08:00', total: 0 }, { name: '10:00', total: 0 },
                { name: '12:00', total: 0 }, { name: '14:00', total: 0 },
                { name: '16:00', total: 0 }, { name: '18:00', total: 0 },
            ];
        } else if (period === 'week') {
            return [
                { name: 'Seg', total: 0 }, { name: 'Ter', total: 0 },
                { name: 'Qua', total: 0 }, { name: 'Qui', total: 0 },
                { name: 'Sex', total: 0 }, { name: 'Sáb', total: 0 },
                { name: 'Dom', total: 0 },
            ];
        }
        return [
    ...
    const getEcommerceChartData = () => {
        if (period === 'day') {
            return [
                { name: '08:00', visitors: 0, sales: 0 }, { name: '12:00', visitors: 0, sales: 0 },
                { name: '16:00', visitors: 0, sales: 0 }, { name: '20:00', visitors: 0, sales: 0 },
                { name: '00:00', visitors: 0, sales: 0 },
            ];
        }
        return [
            { name: 'Sem 1', visitors: 0, sales: 0 }, { name: 'Sem 2', visitors: 0, sales: 0 },
            { name: 'Sem 3', visitors: 0, sales: 0 }, { name: 'Sem 4', visitors: 0, sales: 0 },
        ];
    };

    const generalPaymentData = [
        { name: 'Crédito', value: 0 }, { name: 'Débito', value: 0 },
        { name: 'Dinheiro', value: 0 }, { name: 'Pix', value: 0 },
    ];
                ...
                <div className="space-y-6 animate-in fade-in duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm transition-colors">
                            ...
                            <h3 className="text-2xl font-bold text-pink-600 dark:text-pink-400">--</h3>
                        </div>
                    </div>
